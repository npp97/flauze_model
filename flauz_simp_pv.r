...
upper[]= 1;
system.time({
MCMC<-mdMCMC1(ff=FRAUZcost1,pp=pp,obs=obs,niter=15000,y=y0,times,wvar0=0.1,updatecov=100,lower=lower,upper=upper,burninlength=5000);
MCMC_SS<-mdMCMC(ff=FRAUZcost,pp=pp,obs=obs,niter=15000,y=y0,SS,times,wvar0=0.1,updatecov=100,lower=lower,upper=upper,burninlength=5000);
})
### MCMC output
#------------------------------------------------------------------------------
print(summary(MCMC))
